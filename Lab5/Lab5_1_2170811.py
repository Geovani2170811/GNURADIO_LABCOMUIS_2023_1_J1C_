...
class Lab5_1_2170811(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "Lab5_1_2170811")
        ...
        self._Am_win = RangeWidget(self._Am_range, self.set_Am, "Amplitud mje", "counter_slider", float, QtCore.Qt.Horizontal)
...
def main(top_block_cls=Lab5_1_2170811, options=None):
