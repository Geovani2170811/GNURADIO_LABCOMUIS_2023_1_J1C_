...
class LAB1_2170811(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "LAB1_2170811")
        ...
        self.frecuency = frecuency = 500
        self.amplitude = amplitude = 1

        ##################################################
        # Blocks
        ##################################################
        self._frecuency_range = Range(500, 5000, 500, 500, 200)
...
def main(top_block_cls=LAB1_2170811, options=None):
